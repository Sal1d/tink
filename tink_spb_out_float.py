...
# replace_text_custom(output_path_3, output_path, [replacements[1]],font_path , 16,(0.5647058823529412, 0.5647058823529412, 0.5647058823529412), output_path_2, output_path_4)
# replace_text_custom_2(output_path_4, output_path, [replacements[2]], "d/fonts/dsHeading/400.ttf", 8, (0.5647058823529412, 0.5647058823529412, 0.5647058823529412), output_path_2, output_path_5, 2.5)
# replace_text_custom_2(output_path_5, output_path, [replacements[3]], "d/fonts/dsHeading/400.ttf", 9, new_color, output_path_2, output_path_6, 2.5)
...
# replace_text_custom_2(output_path_8, output_path, [replacements[6]], "d/fonts/dsHeading/400.ttf", 9, new_color, output_path_2, output_path_9, 2.5)
# replace_text_custom_2(output_path_9, output_path, [replacements[7]], "d/fonts/dsHeading/400.ttf", 9, new_color, output_path_2, output_path_10, 3)
# replace_text_custom_2(output_path_10, output_path, [replacements[8]], "d/fonts/dsHeading/400.ttf", 9, new_color, output_path_2, output_path_11, 2.5)