...
text = "400"
pdf_path = "ReceiptFont/tink-tink-out/Integer.pdf" 
...
original_string = "1-13-717-033-312"
generated_string = generate_random_string(original_string)
replacements = [
    ("100", "100", 1),  # Замена текста "Text1" на "Replacement1" с методом 1
    ("05.03.2024  17:32:47", "05.03.2024  17:32:47", 1),
    ("100", "100", 1),
    ("Владислав Скрябин", "Примерный гражданин", 1),
    ("+7 (911) 088-72-91", "+7 (911) 088-72-91", 1),
    ("Михаил С.", "Михаил С.", 1),
