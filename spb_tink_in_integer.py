...
text = "400"
pdf_path = "ReceiptFont/sbp-tink-in/Integer.pdf"
...
original_string = "2-11-993-662-247"
generated_string = generate_random_string(original_string)
generated_rrn = generate_rrn()
replacements = [
    ("1 000", "1 000", 1),  # Замена текста "Text1" на "Replacement1" с методом 1
    ("25.02.2024  19:22:33", "25.02.2024  19:22:33", 1),
    ("+7 (981) 032-89-83", "+7 (981) 032-89-84", 1),
    ("011993662247", generated_rrn, 1),
    (original_string, generated_string, 1)
]
new_size = 16.25  # Размер шрифта для нового текста
