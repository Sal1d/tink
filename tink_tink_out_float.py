...
text = "400"
pdf_path = "ReceiptFont/tink-tink-out/Float.pdf"  
...
output_path_9 = "result_7.pdf"
output_path_10 = "result_8.pdf"
output_path_11 = "final.pdf"


font_path = "d/fonts/EEX.ttf" 
original_string = "1-14-270-123-136"
generated_string = generate_random_string(original_string)
replacements = [
    ("0,12", "11223,23", 1),  
    ("11223", "11223", 1),
    (",23", ",33", 1),
    ("02.04.2024  17:22:28", "04.04.2024  11:46:03", 1),
    ("0,12", "1,30", 1),
...
replace_text_custom(output_path_3, output_path, [replacements[1]],font_path , 16,new_color, output_path_2, output_path_4)
replace_text_custom(output_path_4, output_path, [replacements[2]], font_path, new_size, (0.5647058823529412, 0.5647058823529412, 0.5647058823529412), output_path_2, output_path_5)

replace_text_custom_2(output_path_5, output_path, [replacements[3]], "d/fonts/dsHeading/400.ttf", 8, (0.5647058823529412, 0.5647058823529412, 0.5647058823529412), output_path_2, output_path_6, 2.5)
replace_text_custom_2(output_path_6, output_path, [replacements[4]], "d/fonts/dsHeading/400.ttf", 9, new_color, output_path_2, output_path_7, 2.5)
replace_text_custom_2(output_path_7, output_path, [replacements[5]], "d/fonts/dsHeading/400.ttf", 9, new_color, output_path_2, output_path_8, 3)
...
replace_text_custom_2(output_path_9, output_path, [replacements[7]], "d/fonts/dsHeading/400.ttf", 9, new_color, output_path_2, output_path_10, 2.5)
replace_text_custom_2(output_path_10, output_path, [replacements[8]], "d/fonts/dsHeading/400.ttf", 9, new_color, output_path_2, output_path_11, 3)